...
class SteresCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("sustentacionclases:steress")
...
def delete_steres_view(request, pk):
    ...
    steres.delete()
    return redirect("sustentacionclases:steress")
...
class UserCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("sustentacionclases:users")
...
def delete_user_view(request, pk):
    ...
    user.delete()
    return redirect("sustentacionclases:users")
...
class PreductsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("sustentacionclases:preductss")
...
def delete_preducts_view(request, pk):
    ...
    preducts.delete()
    return redirect("sustentacionclases:preductss")
...
class SheppingcartCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("sustentacionclases:sheppingcarts")
...
def delete_sheppingcart_view(request, pk):
    ...
    sheppingcart.delete()
    return redirect("sustentacionclases:sheppingcarts")
